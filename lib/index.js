...
// images!
Visitor.prototype.visitFIGURE = function(node) {
	...
	if (/[.](svg|gif)$/i.test(filename)) { return; } // skip svg and gif
	this.output.push('\\begin{figure}[tbh]');
	this.output.push('\\begin{center}');
	this.output.push('\\includegraphics[width=0.9\\columnwidth]{'+filename+'}');
	this.output.push('\\end{center}');
	if (caption) {
