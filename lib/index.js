...
var generateLatex = function(metabook, builddir, imagemap, options) {
	...
	if(footer) {
			var logoPath = path.join(__dirname, '..', 'tex', 'logoBW.tex');
            head = head.replace(/(\\pagestyle\{headings\})/, "\\usepackage{lastpage}\n\\usepackage[ddmmyyyy,hhmmss]{datetime}\n\\usepackage{fancyhdr}\n\\usepackage{etoolbox}\n\\fancypagestyle{plain}{\n\\fancyhf{}\n\\fancyhead[LO,RE]{\\leftmark}\n\\fancyfoot[LE,LO]{wikitolearn.org}\n\\fancyfoot[CE,CO]{\\input{" + logoPath + "}}\n\\fancyfoot[RE,RO]{\\thepage\\ / \\pageref{LastPage}}\n\\renewcommand{\\footrulewidth}{0.5pt}\n\\renewcommand{\\headrulewidth}{0.5pt}\n}\n\\pagestyle{plain}\n\\makeatletter\n\\patchcmd{\\tableofcontents}\n{\\@starttoc}\n{\\thispagestyle{empty}\\@starttoc}\n{}{}\n\\makeatother");
	...
	// Start the doc!
	var logoPathColor = path.join(__dirname, '..', 'tex', 'logoColor.tex');
	headFormat.writeDecorated('\\begin{document}\\input{' + logoPathColor + '}\\maketitle\n');
	if (toc) {
